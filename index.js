...
//nestedFunction() is created inside of myFunction() and they are in the same scope. This inner function reaches into it's parents scope to grab a value in the parent. The nested function can access to the local function and variables, which is access to myFunction() and grab 'internal'.
